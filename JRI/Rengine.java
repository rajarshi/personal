...
public class Rengine extends Thread {
    ...
    */
    ...
    //    public synchronized native long rniAttrs(long exp);
	...
	@since JRI 0.3
	@param s expression (as string) to parse and evaluate
	@param convert if set to <code>true</code> the resulting REXP will contain native
 representation of the contents, otherwise an empty REXP will be returned. Depending on 
the back-end an empty REXP may or may not be used to convert the result at a later point.
	@return resulting expression or <code>null</code> if something wnet wrong */
