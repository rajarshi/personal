...
class displayStructureAsPDFTable extends displayStructure {
    ...
    public void drawStructure(IAtomContainer mol, int cnt) {
        ...
        try {
            ...
            GeometryTools.translateAllPositive(this.mol, r2dm.getRenderingCoordinates());
            GeometryTools.scaleMolecule(this.mol, getPreferredSize(), this.scale, r2dm.getRenderingCoordinates());
            GeometryTools.center(this.mol, getPreferredSize(), r2dm.getRenderingCoordinates());
